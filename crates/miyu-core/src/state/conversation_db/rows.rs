...
pub(crate) const SESSION_COLUMNS: &str = "session_id, persona, name, kind, parent_session_id, workspace, sandbox_read_all, archived, created_at, updated_at, sort_key, owner";
