...
pub(in crate::web) fn redact_api_quota_provider(
    states: &mut HashMap<String, bool>,
    prefix: &str,
    provider: &mut miyu_base::config::ApiQuotaProviderConfig,
) {
    if provider.accounts.is_empty() {
        provider
            .accounts
            .push(miyu_base::config::ApiQuotaAccountConfig {
...
pub(in crate::web) fn restore_api_quota_provider(
    candidate: &mut miyu_base::config::ApiQuotaProviderConfig,
    current: &miyu_base::config::ApiQuotaProviderConfig,
